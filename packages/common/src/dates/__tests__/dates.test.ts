...
describe('Date Helpers', () => {
    ...
    test('timespan', () => {
        ...
        expect(DateHelpers.Format.timespan(10912939)).toBe('3h 1m 53s');
    ...
    test('addDays', () => {
        ...
        expect(DateHelpers.addDays(
            baseDate,
            16,
            e => e == new Date('2030-08-12T10:26:15.893Z'),
            37,
        )).toStrictEqual(new Date('2020-09-18T10:26:15.893Z'));
    });
